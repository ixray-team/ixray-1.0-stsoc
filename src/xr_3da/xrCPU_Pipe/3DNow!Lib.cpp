...
static const __m64i smh_masks   =   { (int) 0x807fffff, (int) 0x807fffff      }; // dword MASKSMH, MASKSMH
static const __m64i sign_mask   =   { 0x7fffffff,   0x7fffffff      };
static const __m64i sh_masks    =   { (int) 0x80000000, (int) 0x80000000      }; // dword MASKSH, MASKSH
...
static const __int32 nan_       =       0x7fffffff;
...
static const __int32 bnd_        =       0x3F133333;
