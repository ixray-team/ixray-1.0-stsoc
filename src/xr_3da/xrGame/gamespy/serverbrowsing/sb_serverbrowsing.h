...
typedef void (__cdecl *ServerBrowserCallback)(ServerBrowser sb, SBCallbackReason reason, SBServer server, void *instance);
...
ServerBrowser __cdecl ServerBrowserNew(const gsi_char *queryForGamename, const gsi_char *queryFromGamename, const gsi_char *queryFromKey, int queryFromVersion, int maxConcUpdates, int queryVersion, ServerBrowserCallback callback, void *instance);

/* 
ServerBrowserFree
-----------------
Free a ServerBrowser and all internal sturctures and servers */
void __cdecl ServerBrowserFree(ServerBrowser sb);
...
*/ 
SBError __cdecl ServerBrowserUpdate(ServerBrowser sb, SBBool async, SBBool disconnectOnComplete, const unsigned char *basicFields, int numBasicFields, const gsi_char *serverFilter);
...
SBError __cdecl ServerBrowserLANUpdate(ServerBrowser sb, SBBool async, unsigned short startSearchPort, unsigned short endSearchPort);
...
SBState __cdecl ServerBrowserState(ServerBrowser sb);
...
void __cdecl ServerBrowserHalt(ServerBrowser sb);

/* ServerBrowserClear
-------------------
Removes all the servers from the list and frees all resources associated with them. */
void __cdecl ServerBrowserClear(ServerBrowser sb);
...
int __cdecl SBServerGetPing(SBServer server);
...
char * __cdecl SBServerGetPublicAddress(SBServer server);
...
unsigned short _cdecl SBServerGetPublicQueryPort(SBServer server);
...
const gsi_char * __cdecl SBServerGetStringValue(SBServer server, const gsi_char *keyname, const gsi_char *def);
int __cdecl SBServerGetIntValue(SBServer server, const gsi_char *key, int idefault);
double __cdecl SBServerGetFloatValue(SBServer server, const gsi_char *key, double fdefault);
SBBool __cdecl SBServerGetBoolValue(SBServer server, const gsi_char *key, SBBool bdefault);
