////////////////////////////////////////////////////////////////////////////
//	Module 		: data_storage_fixed_vertex_manager.h
//	Created 	: 21.03.2002
//  Modified 	: 01.03.2004
//	Author		: Dmitriy Iassenev
//	Description : Data storage fixed vertex manager
////////////////////////////////////////////////////////////////////////////
...
template <
	...
	u8 mask
>
struct CFixedVertexManager {

	template <template <typename _T> class T1>
	struct FixedVertexManager {
	...
	template <
		...
		typename _data_storage = CConstructorBaseAllocator
	> 
	class CDataStorage : public _data_storage::CDataStorage<FixedVertexManager<_vertex>::_vertex> {
	public:
		typedef typename _data_storage::CDataStorage<
			FixedVertexManager<_vertex>::_vertex
		>												inherited;
...
#include "data_storage_fixed_vertex_manager_inline.h"