	...
	struct conversion_sequence {
		...
		struct list_iterator {
			...
			struct selector {
				...
				typedef typename _selector<!std::is_same<Loki::NullType,helper_result>::value>::value result;
			};
			...
			struct selector<false> {
				...
				struct _selector {
					...
					typedef typename _selector2<!std::is_same<Loki::NullType,helper_result>::value>::value result;
				};
